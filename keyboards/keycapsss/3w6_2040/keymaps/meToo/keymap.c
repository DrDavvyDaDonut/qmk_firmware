...
const int MC_OFFSET = 74; //  offset from numbers to f13 and beyond
...
*/
  ...
  [_FUNC] = LAYOUT_split_3x5_3(
    ...
    KC_LCTL,  KC_CAPS,  _______,  _______,  _______,                      MS_WHLU,  SOCD_ML,  SOCD_MD,  SOCD_MR,  MS_BTN1,
...
{0, 2}, {1, 2}, {2, 2}, {3, 2}, {4, 2},                 {4, 6}, {3, 6}, {2, 6}, {1, 6}, {0, 6},
                        {2, 3}, {3, 3}, {4, 3}, {4, 7}, {3, 7}, {2, 7}
