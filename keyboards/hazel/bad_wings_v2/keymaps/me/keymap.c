...
*/
  ...
  [_STICKS] = LAYOUT_split_3x5_3(
    _______,  _______,  LS_UPUP,  _______,  _______,                      _______,  _______,  _______,  _______,  _______,
    _______,  LS_LEFT,  LS_DOWN,  LS_RGHT,  _______,                      _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,                      _______,  _______,  _______,  _______,  _______,
                                  _______,  _______,  _______,  _______,  _______,  _______
  )
  // clang-format on
